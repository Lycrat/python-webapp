...
INSERT INTO `users` VALUES (1,'testuser','testpassword');
...
--
/*!50003 DROP PROCEDURE IF EXISTS `pAddJoke` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pAddJoke`(
	IN jokeSetup VARCHAR(255),
    IN jokePunchline VARCHAR(255)
)
BEGIN
	INSERT INTO jokes (Setup, Punchline)
    VALUES (jokeSetup, jokePunchline);
END ;;
DELIMITER ;
...
-- Dump completed on 2025-10-02 10:02:59
